...
alias proj='cd /mnt/c/dev/projects'
alias cls='clear'

# C/C++ alieses
alias debugc='gcc -std=c17 -g -O0 -Wall'
alias debug='g++ -std=c++14 -g -Wall'
alias buildc='gcc -std=c17 -O3 -w -s'
alias build='g++ -std=c++14 -O3 -w -s'
